...
- Which fields are worth sorting by was never discussed. Cards currently carry title, lane, manual position, notes (with timestamps), tags, linked people, linked companies, and linked email conversations; there is no due date, priority, or created-date shown anywhere in the UI yet.
