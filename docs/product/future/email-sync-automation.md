...
- Reaffirmed by the 2026-08-21 MCP audit as the enabler of a future proactive assistant — push/webhook sync replacing the pull-only `sync-emails`/`sync-calendar` triggers.
