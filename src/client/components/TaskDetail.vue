...
import type { Company, LinkedPerson, Note, Tag, TaskDetail as TaskDetailType } from '../../shared/types.js';
import DeleteCardConfirm from './DeleteCardConfirm.vue';
import LinkedCompanies from './LinkedCompanies.vue';
import LinkedConversations from './LinkedConversations.vue';
...
const task = ref<TaskDetailType | null>(null);
const tagError = ref('');
const laneError = ref('');
